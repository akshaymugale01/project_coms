...
import { deleteFilePersonal, deleteFolderPersonal, deleteShareFile, deleteShareFolder, getFolderDocumentCommon, getFolderDocumentPersonal, getSetupUsers, getSharedwith, getSubFolderDocumentCommon, postFileDocumentCommon, postFolderDocumentPersonal, postSharePersonal } from "../../api";
        ...
        <div className="p-6  min-h-screen">
            ...
            <div className="bg-white  rounded-lg   ">
                ...
                <div className="flex flex-col space-y-2">
                    {folders.length === 0 && files.length === 0 && <p>No folders and files found.</p>}
                                    ...
                                    {menuOpen === folder.id && (
                                        <div className="absolute bg-white shadow-md rounded-md p-2 right-0">
                                            <button
                                                ...
                                                onClick={() => handleShareClick(folder.folderId, "folder")}
                                            >
                                                Share
                                            </button>
                                            <button
                                ...
                                <div className="absolute top-2 right-2">
                                    ...
                                    {menuOpen === file.id && (
                                        <div className="absolute bg-white shadow-md rounded-md p-2 right-0">
                                            <button
                                                className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
                                                onClick={() => handleShareClick(file.documentId, "file")}
                                            >
                                                Share
                                            </button>
                                            <button
