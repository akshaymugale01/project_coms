...
const EditServiceChecklist = () => {
  ...
  return (
    <section>
      <div className="m-2">
        <h2
          className="text-center text-xl font-bold p-2  rounded-full text-white bg-gray-900"
        >
          {isEditing ? " Edit  Checklist" : "Soft Service Checklist Details"}
        </h2>
        <div className="md:mx-20 my-5 mb-10 sm:border border-gray-400 p-5 px-10 rounded-lg sm:shadow-xl">
          ...
          <div className="flex  flex-col justify-around">
            <div className="grid md:grid-cols-3 item-start gap-x-4 gap-y-2 w-full">
              ...
              <div className="flex flex-col">
                <label htmlFor="prioritylevel" className="font-semibold">
                  Priority Level
                </label>
                <select
                  name="prioritylevel"
